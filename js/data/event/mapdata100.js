MAP100 = {
	...
	maps: {
		...
		6: {
			...
			lbasData2:{
				3: [
					{ planes: [562,562,561,561], planeCount: [24, 24, 12, 12] },
					{ planes: [562,562,561,561], planeCount: [24, 24, 12, 12] },
					{ planes: [595,594,562,561], planeCount: [24, 24, 12, 12] },
				],
				2: [
					{ planes: [562,561,561,561], planeCount: [24, 12, 6, 6] },
					{ planes: [562,561,561,561], planeCount: [24, 12, 6, 6] },
				],
				1: [
					{ planes: [561,561,561,561], planeCount: [24, 12, 6, 6] },
					{ planes: [561,561,561,561], planeCount: [24, 12, 6, 6] },
				],
			},
			parts:{
				...
				2:{
					...
					lbasTargeting: [
						// part 1
						{ letter: 'L', selectStart: 1, selectEnd: 0.65, lockWaves2: [0,1,2] },
						{ letter: 'M', selectStart: 1, selectEnd: 0.65, lockWaves2: [0,1,2] },
						// part 2
						{ letter: 'L', selectStart: 0.65, selectEnd: 0.3, lockWaves2: [0] },
						{ letter: 'M', selectStart: 0.65, selectEnd: 0.3, lockWaves2: [0] },
						{ letter: 'O', selectStart: 0.65, selectEnd: 0.3, lockWaves2: [1,2], },
						{ letter: 'Q', selectStart: 0.65, selectEnd: 0.3, lockWaves2: [1,2], },
						// part 3
						{ letter: 'O', selectStart: 0.3, selectEnd: 0, lockWaves2: [1] },
						{ letter: 'Q', selectStart: 0.3, selectEnd: 0, lockWaves2: [1] },
						{ letter: 'Y', selectStart: 0.3, selectEnd: 0, lockWaves2: [0,0,2,2] },
					],
					transport: null,
				},
				3:{
					...
					lbasTargeting: [
						// part 1
						{ letter: 'Q', selectStart: 1, selectEnd: 0.7, lockWaves2: [2,2] },
						{ letter: 'Z', selectStart: 1, selectEnd: 0.7, lockWaves2: [0,0] },
						{ letter: 'Z3', selectStart: 1, selectEnd: 0.7, lockWaves2: [1,1] },
						// part 2
						{ letter: 'Z', selectStart: 0.7, selectEnd: 0.35, lockWaves2: [1,2] },
						{ letter: 'Z3', selectStart: 0.7, selectEnd: 0.35, lockWaves2: [1,2] },
						{ letter: 'Z4', selectStart: 0.7, selectEnd: 0.35, lockWaves2: [0,0] },
						// part 3
						{ letter: 'Z', selectStart: 0.35, selectEnd: 0, lockWaves2: [2] },
						{ letter: 'Z3', selectStart: 0.35, selectEnd: 0, lockWaves2: [2] },
						{ letter: 'Z4', selectStart: 0.35, selectEnd: 0, lockWaves2: [0,0,1,1] },
					],
					lbas: 3,
					maphp: {
						3: { 1: 4200 },
				...
				'Y': {
					...
					debuffGive: function(){
						if(CHDATA.temp.rank == 'S' && Math.random() < 0.1 || CHDATA.temp.rank == 'A' && Math.random() < 0.05){
							chAddReward({ ships: [{ id: 990, lvl: 99 }], firstOnly: true });
							chShowReward({ ships: [{ id: 990, lvl: 99 }], firstOnly: true });
						}
					},
				},
				'Z': {
		...
		7: {
			...
			lbasData2:{
				3: [
					{ planes: [598,597,595,595], planeCount: [16, 16, 16, 16] },
					{ planes: [598,597,595,595], planeCount: [16, 16, 16, 16] },
					{ planes: [598,597,595,595], planeCount: [16, 16, 16, 16] },
				],
				2: [
					{ planes: [597,597,595,594], planeCount: [12, 12, 16, 16] },
					{ planes: [597,597,595,594], planeCount: [12, 12, 16, 16] },
					{ planes: [597,597,595,594], planeCount: [12, 12, 16, 16] },
				],
				1: [
					{ planes: [562,561,595,594], planeCount: [12, 12, 12, 12] },
					{ planes: [562,561,595,594], planeCount: [12, 12, 12, 12] },
					{ planes: [562,561,595,594], planeCount: [12, 12, 12, 12] },
				],
				4: [
					{ planes: [561,561,561,561], planeCount: [10, 10, 8, 8] },
					{ planes: [561,561,561,561], planeCount: [10, 10, 8, 8] },
					{ planes: [561,561,561,561], planeCount: [10, 10, 8, 8] },
				],
			},
			...
			startCheck: function() {
				MAPDATA[100].maps[7].lbasTargeting = [];
				let debuff = CHDATA.event.maps[7].debuff;
				if(debuff){
					if(!debuff.LBAS){
						if(CHDATA.event.maps[7].routes.indexOf(3) !== -1){
							MAPDATA[100].maps[7].lbasTargeting = [
								{ letter: 'U*', selectStart: 1, selectEnd: 0, lockWaves2: [0,0] },
								{ letter: 'H-Y', selectStart: 1, selectEnd: 0, lockWaves2: [1,1] },
								{ letter: 'V', selectStart: 1, selectEnd: 0, lockWaves2: [2,2] },
							];
						}
						else if(CHDATA.event.maps[7].routes.indexOf(2) !== -1){
							MAPDATA[100].maps[7].lbasTargeting = [
								{ letter: 'M-Y', selectStart: 1, selectEnd: 0, lockWaves2: [0,0] },
								{ letter: 'M-Y', selectStart: 1, selectEnd: 0, lockWaves2: [1,1] },
								{ letter: 'M-Y', selectStart: 1, selectEnd: 0, lockWaves2: [2,2] },
							];
						}
						else if(CHDATA.event.maps[7].routes.indexOf(1) !== -1){
							MAPDATA[100].maps[7].lbasTargeting = [
								{ letter: 'I-R', selectStart: 1, selectEnd: 0, lockWaves2: [0,0] },
								{ letter: 'J-R', selectStart: 1, selectEnd: 0, lockWaves2: [1,1] },
								{ letter: 'J-R', selectStart: 1, selectEnd: 0, lockWaves2: [2,2] },
							];
						}
						else{
							MAPDATA[100].maps[7].lbasTargeting = [
								{ letter: 'S', selectStart: 1, selectEnd: 0, lockWaves2: [0,0] },
								{ letter: 'T', selectStart: 1, selectEnd: 0, lockWaves2: [1,1] },
								{ letter: 'U', selectStart: 1, selectEnd: 0, lockWaves2: [2,2] },
							];
						}
					}
					if(debuff.MAPMOD){
